...
from helpers.matrice import afficher_matrice, set_matrice_to_state
...
# Clone main bord for simulations
...
# List of state after each legal action 
...
# Check if current player has won in current board
